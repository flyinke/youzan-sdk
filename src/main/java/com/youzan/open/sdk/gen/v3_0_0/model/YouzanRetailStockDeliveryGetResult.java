...
public class YouzanRetailStockDeliveryGetResult implements APIResult {

    @JsonProperty(value = "response")
    /**
     * 配送单详情
     */
    private ScmDeliveryOrderVO response;

    public void setResponse(ScmDeliveryOrderVO response) {
        this.response = response;
    }

    public ScmDeliveryOrderVO getResponse() {
        return this.response;
    }

    public static class ScmDeliveryOrderVO {

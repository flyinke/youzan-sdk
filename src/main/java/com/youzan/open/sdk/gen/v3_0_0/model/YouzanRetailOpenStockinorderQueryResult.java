...
public class YouzanRetailOpenStockinorderQueryResult implements APIResult {

    @JsonProperty(value = "orders")
    /**
     * 单据信息
     */
    private OpenStockInOrderDTO[] orders;
    ...
    public void setOrders(OpenStockInOrderDTO[] orders) {
        this.orders = orders;
    }

    public OpenStockInOrderDTO[] getOrders() {
        return this.orders;
    }
    ...
    public static class OpenStockInOrderDTO {

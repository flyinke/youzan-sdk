...
public class YouzanMeiGoodsProductGetResult implements APIResult {

    @JsonProperty(value = "response")
    /**
     * 商品详细信息
     */
    private MeiGoodsInfoResp response;

    public void setResponse(MeiGoodsInfoResp response) {
        this.response = response;
    }

    public MeiGoodsInfoResp getResponse() {

...
public class YouzanCardvoucherValuecardRfndRcdBypubSearchResult implements APIResult {
     ...
     * 实体信息
     */
    private PageQueryRefundLogByPublishKdtIdDTO[] items;
    ...
    public void setItems(PageQueryRefundLogByPublishKdtIdDTO[] items) {
        this.items = items;
    }

    public PageQueryRefundLogByPublishKdtIdDTO[] getItems() {
        return this.items;
    }

    public static class PageQueryRefundLogByPublishKdtIdDTO {

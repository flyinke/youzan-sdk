...
public class YouzanMeiOrderListResult implements APIResult {

    @JsonProperty(value = "items")
    /**
     * 订单列表
     */
    private OrderDetailResp[] items;
    ...
    public void setItems(OrderDetailResp[] items) {
        this.items = items;
    }

    public OrderDetailResp[] getItems() {
        return this.items;
    }

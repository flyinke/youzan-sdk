...
public class YouzanCardvoucherValuecardPayRcdBysupSearchResult implements APIResult {

    @JsonProperty(value = "items")
    /**
     * 实体信息
     */
    private PageQueryPayLogBySupportKdtIdDTO[] items;
    ...
    public void setItems(PageQueryPayLogBySupportKdtIdDTO[] items) {
        this.items = items;
    }

    public PageQueryPayLogBySupportKdtIdDTO[] getItems() {
        return this.items;
    }
    ...
    public static class PageQueryPayLogBySupportKdtIdDTO {

...
public class YouzanUmpPresentsOngoingAllResult implements APIResult {

    @JsonProperty(value = "presents")
    /**
     * 赠品列表
     */
    private UmpPresent[] presents;

    public void setPresents(UmpPresent[] presents) {
        this.presents = presents;
    }

    public UmpPresent[] getPresents() {
...
GOODS_SCAN_DISCOUNT(扫码直接折扣) <br>
    ...
    public static class UmpPresent {
            @JsonProperty(value = "start_at")
        /**
        * 赠品生效时间，时间格式：yyyy-MM-dd HH:mm:ss
        */
        ...
        */
        ...
        /**
        * 赠品结束时间，时间格式：yyyy-MM-dd HH:mm:ss
        */
        private Date endAt;
        ...
        */
        private Long presentId;
            @JsonProperty(value = "created")
        /**
        * 赠品创建时间，时间格式：yyyy-MM-dd HH:mm:ss
        */
        private Date created;
            @JsonProperty(value = "fetch_limit")
        /**
        * 领取限制，每个人限领多少个，必须大于0
        */

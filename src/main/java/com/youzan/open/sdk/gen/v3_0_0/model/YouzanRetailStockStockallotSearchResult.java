...
public class YouzanRetailStockStockallotSearchResult implements APIResult {

    @JsonProperty(value = "response")
    /**
     * 返回信息
     */
    private StockAllotSearchPaginatorVO response;

    public void setResponse(StockAllotSearchPaginatorVO response) {
        this.response = response;
    }

    public StockAllotSearchPaginatorVO getResponse() {
        return this.response;
    }

    public static class PaginWithInterBusinessVO {
...
1:待审核  2:待出库  3:待入库  4:已驳回  5:已关闭  6：已完成  7:出库执行中（处理中状态）  8:入库执行中（处理中状态）
    ...
    public static class StockAllotSearchPaginatorVO {
        ...
        * 单据分页列表信息
        */
        private PaginWithInterBusinessVO data;
        ...
        public Long getRefusedNum() {
            ...
            public void setData(PaginWithInterBusinessVO data) {
            this.data = data;
        }

        public PaginWithInterBusinessVO getData() {
            return this.data;
        }

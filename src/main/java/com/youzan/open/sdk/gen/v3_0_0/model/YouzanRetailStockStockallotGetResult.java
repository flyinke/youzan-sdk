...
public class YouzanRetailStockStockallotGetResult implements APIResult {

    @JsonProperty(value = "response")
    /**
     * 单据信息
     */
    private ScmInterBusinessOrderVO response;

    public void setResponse(ScmInterBusinessOrderVO response) {
        this.response = response;
    }

    public ScmInterBusinessOrderVO getResponse() {
        return this.response;
    }

    public static class ScmInterBusinessOrderVO {

...
public class YouzanRetailStockStockoutGetResult implements APIResult {

    @JsonProperty(value = "stock_out_order_vo")
    /**
     * 出库单详情数据
     */
    private StockOutOrderVO stockOutOrderVo;

    public void setStockOutOrderVo(StockOutOrderVO stockOutOrderVo) {
        this.stockOutOrderVo = stockOutOrderVo;
    }

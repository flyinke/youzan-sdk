...
public class YouzanCardvoucherValuecardRechgRcdByacpSearchResult implements APIResult {

    @JsonProperty(value = "items")
    /**
     * 实体信息
     */
    private PageQueryRechargeLogByAcceptKdtIdDTO[] items;
    ...
    public void setItems(PageQueryRechargeLogByAcceptKdtIdDTO[] items) {
        this.items = items;
    }

    public PageQueryRechargeLogByAcceptKdtIdDTO[] getItems() {
        return this.items;
    }
    ...
    public static class PageQueryRechargeLogByAcceptKdtIdDTO {
